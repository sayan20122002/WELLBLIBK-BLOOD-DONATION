  ...
  <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        ...
        <div class="ctext"><strong>Profile</strong></div>
        <!--<div class="ctext1">Home <i class="fa fa-circle-o"></i> About</div>-->
        <!--<p>Make an Make an Appointment</p>-->
      </div>

    </div>
    <div class="ctext1">Home&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Profile</div>
  </section><!-- End Cta Section -->

  <div class="con-profile">
    <div class="profile-form1" data-aos="fade-down" data-aos-delay="100">
      <form action="profilewb.php" method="post">
        ...
        <br>
        <button class="profile-button">Update Profile</button>
      </form>
    </div>

    <div class="con-pic" data-aos="fade-up" data-aos-delay="100">
        <img src="23.jpg" alt="">
    </div>
  </div>
