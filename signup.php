...
<head>
  ...
  <title>WELL BLINK| Register Yourself</title>
  ...
  <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        ...
        <div class="ctext"><strong>Register Yourself</strong></div>
        <!--<div class="ctext1">Home <i class="fa fa-circle-o"></i> About</div>-->
        <!--<p>Make an Make an Appointment</p>-->
      </div>

    </div>
    <div class="ctext1">Home&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;registration</div>
  </section><!-- End Cta Section -->

  <div class="cons-signup">
    <div class="cons-signup-pic" data-aos="zoom-in" data-aos-delay="100">
      <img src="8.png" alt=" ">
    </div>
      ...
      <div class="gen-form2">
        <div>
          Group <input type="radio" name="gender" value="m" id="male" placeholder="male"> male
      ...
      <div class="form3" >
        <input type="tel" name="age" id="age" placeholder="Age" required>
        <br>
        ...
        <br>
        <input type="password" name="cpassword" id="cpassword" placeholder="Confirm Password" maxlength=8 required>
        <br>
        <button type='submit' class="signup-button">Sign Up
      </button>
    

        <!--<button class="signup-button"><a href="login.php">Sign Up</a></button>-->
        </form>
      </div>

      <p>Already Register? <a href="login.php">Sign In now</a></p>
