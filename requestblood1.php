...
$conn= new mysqli('localhost','root','','bloodrequest');
if($conn->connect_error){
    die('connection failed:'.$conn->connect_error);
}
else{
    $stmt= $conn->prepare("insert into request(fullname,phone,blood,ref,email,message)
    values(?,?,?,?,?,?)");
    $stmt->bind_param("ssssss",$fullname,$phone,$blood,$ref,$email,$message);
    $stmt->execute();
    $stmt->close();
    $conn->close();
}
...
<body>
  ...
  <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        ...
        <div class="ctext"><strong>Blood Request</strong></div>
    ...
    <div class="ctext1">Home&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Blood Request</div>
  ...
  <html>
    ...
    <body>
        <h5><b>DETAILS OF REQUEST OF BLOOD REQUIRER</b></h5>
        <table style="margin: 50px; padding: 10px;" >
            ...
            <tbody>
              ...
              if(!$result){
                die("no records in found". $conn->error);
              }
