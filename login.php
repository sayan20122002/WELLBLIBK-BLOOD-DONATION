...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "Select * from wbsu where email='$email'";
  ...
  <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        ...
        <div class="ctext"><strong>Log In</strong></div>
        <!--<div class="ctext1">Home <i class="fa fa-circle-o"></i> About</div>-->
        <!--<p>Make an Make an Appointment</p>-->
      </div>

    </div>
    <div class="ctext1">Home&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Log In</div>
  ...
  <div class="cons-log">
    <div class="log-form1">
      <form action="login.php" method="post">
        ...
        <br>
        <p><a href="contact us.php">forget password</a></p>
        <button class="log-button1"><a href="profile.php">Sign In</a></button>
        <br>
        </form>
