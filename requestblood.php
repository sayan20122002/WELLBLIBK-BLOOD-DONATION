...
<head>
  ...
  <title>WELL BLINK| Contact Reqired Blood</title>
  ...
  <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        ...
        <div class="ctext"><strong>Contact for blood</strong></div>
    ...
    <div class="ctext1">Home&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Requirement Of Blood</div>
  </section><!-- End Cta Section -->



  <div class="contact-con-re" >
    <div class="location-box"data-aos="fade-up" data-aos-delay="700">
      <div class="he-box">
        <p>Contact-Us</p>
      </div>
      <div class="he-box1">
        <p>Avaliable<br> HelpLine</p>
      </div>
      <div class="re-location">
        <i class="fa-solid fa-location-dot"></i>
      </div>
      <div class="re-location-text">
        <p>Our Office</p>
      </div>
      <div class="re-location-text1">
        <p>81, Nilgunj Rd, Jagarata Pally, Deshpriya Nagar,<br> Agarpara, Kolkata, West Bengal:- 700109</p>
      </div>
      <div class="re-email">
        <i class="fa-solid fa-envelope"></i>
      </div>
      <div class="re-email-text">
        <p>Email Us</p>
      </div>
      <div class="re-email-text1">
        <p>wellblink9@gmail.com</p>
      </div>
      <div class="re-phone">
        <i class="fa-solid fa-phone"></i>
      </div>
      <div class="re-phone-text">
        <p>Call Us</p>
      </div>
      <div class="re-phone-text1">
        <P>+91 9874791163</P>
      </div>
    </div>


    <div class="re-form" data-aos="fade-down" data-aos-delay="700">
      <form action="requestblood1.php" method="post">
      <input type="text" name="fullname" id="fullname" placeholder="Full Name" required>
      <br>
      <input type="tel" name="phone" id="phone" placeholder="Mobile Number" required>
      <br>
      <input type="text" name="blood" id="blood" placeholder="Blood type" required>
      <br>
      <input type="text" name="ref" id="ref" placeholder="Reason for blood" required>
      <br>
      <input type="email" name="email" id="email" placeholder="Email Id" required>
      <br>
      <textarea name="message" rows="5" cols="33" placeholder="Message"></textarea>
      <br>
      <button class="re-button">Send Request</button></form>
    </div>
