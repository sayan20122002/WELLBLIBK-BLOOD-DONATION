...
<head>
  ...
  <title>WELL BLINK| About Us</title>
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <div class="ctext"><strong>About Us</strong></div>
          ...
          <div class="container" data-aos="fade-up">
            ...
            <div class="row">
              <div class="col-lg-6" data-aos="fade-left" data-aos-delay="700">
                <div class="img1">
                  <img src="1.webp" class="img-fluid" alt="" style="height: 508px;">
                </div>
              </div>
              <div class="col-lg-6 pt-4 pt-lg-0 content p-3" data-aos="fade-up">
                <div class="abox">
                  <h5>
                ...
                <!--<div class="line">
                  <strong><hr size="3" width="10%">&nbsp<hr size="3" width="5%"></strong>
                </div>-->
                <div class="abox1">
                  Donate Blood & Get Real Blessings
                </div>
                <div class="abox2">
                  <div class="abox3"><i><strong>Welcome to WELL BLINK</strong></i></div>
                  <div class="abox4">
                    <p><i><strong>Blood bank o provide a management functional to the blood bank in order to handle the blood bag and to 
                    make entries of the individuals who want to donate blood and who are in 
                    HOSPITAL.</strong></i></p>
                  </div>
                </div>
                <div class="abox5">
                  <div class="abox6"><i><strong>UNIVERSAL DONORS AND RECIPIENTS</strong></i></div>
                  <div class="abox7">
                    <p><i><strong>The most common blood type is O, followed by type A. 
                      ...
                      "universal recipients" because they can receive blood of any type.<br><br>
                      .</strong></i></p>
                  </div>
                </div>
                <!--<div class="box5">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <a href="mailto:snehapal554@gmail.com"><i class="fa-solid fa-envelope"></i></a>
                <a href="https://www.facebook.com/sukalyan.porey.7?mibextid=ZbWKwL" class="facebook"><i class="bx bxl-facebook"></i></a>
                <a href="https://www.instagram.com/sayansaha8310/" class="instagram"><i class="bx bxl-instagram"></i></a>
                <!--<a href="#" class="google-plus"><i class="bx bxl-skype"></i></a>-->
                <a href="https://www.linkedin.com/in/7-suriti-bhunia-02b836278/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
              </div>
            </div>
          </div>
