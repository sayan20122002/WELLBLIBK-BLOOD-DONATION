...
<head>
  ...
  <title>WELL BLINK| Search Donor</title>
  ...
  <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        ...
        <div class="ctext"><strong>Search Donor</strong></div>
...
<div class="se-features-con">

  <div class="se-features">
    <div class="box1-left">
    </div>
  </div>
  <div class="container-box1" data-aos="fade-right" data-aos-delay="10">
    <p>Gives Blood Save Lifes</p>
  </div>
  <div class="container-box2" data-aos="fade-left">
    <p>Over the years, blood banking has helped save countless lives. Today, about 13.6 million units of blood are donated per year. About 36,000 units of blood are needed each day. Thanks to advances in medical technology, 
    blood banks can safely store blood donations, 
    and process and screen blood to ensure safety for all.</p>
  </div>

  <div class="container-box3">
  </div>
  <div class="container-text">
   <p><b>Search a Donor</b></p>
  </div>
  <div class="se-form1">
    <form action="searchdonorlist.php" method="post">
    <input type="text" name="blood" id="name" placeholder="Blood Group" required>
    <input type="text" name="location" id="location" placeholder="Location" required>
    <a href="donor.php"><button class="se-button">Submit</button></a>
    </form>
  </div>
</div>

<!--<div class="sedocon">
  <div class="sedo-im" data-aos="zoom-in" data-aos-delay="700">
    <img src="5.png" alt="blood">
  </div>
  <div class="sedo-form" data-aos="fade-left" data-aos-delay="400">
    <label for="exampleFormControlInput1" class="form-label">Your First Name:</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter First Name"><br>
        <label for="exampleFormControlInput1" class="form-label">Your Last Name:</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter Last Name"><br>
        <label for="exampleFormControlInput1" class="form-label">DOB:</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter Your Date of Birth"><br>
        <label for="exampleFormControlInput1" class="form-label">Blood Group:</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Required Blood Group" name="blood" required><br>
        ...
        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Enter Your Email"><br>
          ...
          <button class="button"><a href="donor.php">Search</a></button>
  </div>
</div>-->
  ...
  <!--<div class="contact-info">
        ...
        <div class="info-location">
          ...
          <h4>Our Address</h4>
          <h5>42/1 M.C. Garden Road Kol-30</h5>
        </div>
        <div class="contact-email">
          <div class="info-mail">
            <i class="fa-solid fa-envelope"></i>
              <h4>Email Us</h4>
              <h5>ss4177085@gmail.com</h5><br>
              <h5>ss4177085@gmail.com</h5>
          </div>
        </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <a href="mailto:suritibhunia@gmail.com"><i class="fa-solid fa-envelope"></i></a>
                <a href="https://www.facebook.com/Snehapal.01" class="facebook"><i class="bx bxl-facebook"></i></a>
                <a href="https://www.instagram.com/sayansaha8310/" class="instagram"><i class="bx bxl-instagram"></i></a>
                <!--<a href="#" class="google-plus"><i class="bx bxl-skype"></i></a>-->
                <a href="https://www.linkedin.com/in/sneha-pal-programmer/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
              </div>
            </div>
          </div>
