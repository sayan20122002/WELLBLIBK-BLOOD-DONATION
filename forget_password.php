...
<head>
  ...
  <title>WELL BLINK| Sign In</title>
    ...
    <div class="container-fluid header-container d-flex align-content-between justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="donor.html">Donor List</a></li>
          <li><a class="nav-link scrollto" href="searchdonor.html">search Donor</a></li>
          <li><a class="nav-link scrollto" href="#contact">Admin</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
        <a href="login.html"><button class="btn btn-primary"><span class="d-none d-md-inline-block">Login/</span>
            Register</button></a>
      </nav><!-- .navbar -->
  ...
  <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        ...
        <div class="ctext"><strong>Change Password</strong></div>
        <!--<div class="ctext1">Home <i class="fa fa-circle-o"></i> About</div>-->
        <!--<p>Make an Make an Appointment</p>-->
      </div>

    </div>
    <div class="ctext1">Home&nbsp;&nbsp;<i class="fa fa-circle-o"></i>&nbsp;&nbsp;Change Password</div>
...
<div class="con-forget">
    <div class="forget-form1">
        ...
        <br>
        <input type="password" name="password" id="password" placeholder="New Password" maxlength=8 required>
        <br>
        <input type="password" name="password" id="password" placeholder="Confirm Password" maxlength=8 required>
        <br><br>
        <button class="forget-pass"><a href=" ">Reset</a></button>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Quick Links</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="donor.html">Donor</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="searchdonor.html">Search Donor</a></li>
